...
// import { KeywordItem } from '../keywords/keywordinterfaces.js';
// import { NewRecordGroupItem, NewMultiRecordGroupItem, NewRecordGroup, NewMultiRecordGroup } from '../keywords/keywordgroup.js';
// import { KeywordValueCollection } from './keywordvaluecollection.js';

// export class NewKeywordCollection implements KeywordValueCollection {
//     keywordGuid: string;
//     Keywords: Keyword[];
//     RecordGroups: NewRecordGroup[];
//     MultiRecordGroups: NewRecordGroup[];
//     items: KeywordCollectionItem[];

//     constructor(keywordGuid: string, items: KeywordValueCollectionItem[], Keywords: NewKeyword[] = [], RecordGroups: NewRecordGroupItem[] = [], MultiRecordGroups: NewMultiRecordGroupItem[] = []) {
